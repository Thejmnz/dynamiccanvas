...
export const KonvaHexagon: React.FC<KonvaHexagonProps> = ({
  element,
  onSelect,
  onChange,
  onDragMove,
  ...
  for (let i = 0; i < 6; i++) {
    const angle = (i * 2 * Math.PI) / 6 - Math.PI / 2; // Empezar desde arriba
