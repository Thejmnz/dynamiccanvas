...
const docsCopy = {
  es: {
    ...
    outputText: "El endpoint produce JPEG optimizado por defecto y también admite PNG y WebP. Conserva la resolución HD; pixelRatio indica la escala aplicada y width/height corresponden a los píxeles finales.",
  ...
  en: {
    ...
    outputText: "The endpoint produces optimized JPEG by default and also supports PNG and WebP. It preserves HD resolution; pixelRatio reports the applied scale and width/height are the final pixel dimensions.",
